...
namespace WebServicePOS
{
    ...
    { 
        ...
        {
            /*
            XmlSerializer serializer = new XmlSerializer(typeof(Classes.Sale));
            Classes.Sale sale = new Classes.Sale();
            using (TextReader reader = new StringReader(saleDocument))
            {
                sale = (Classes.Sale)serializer.Deserialize(reader);
            }*/
            ...
            if (!Int32.TryParse(oCmd.ExecuteScalar().ToString(), out newSaleID))
            {
            ...
            if (!Int32.TryParse(oCmd.ExecuteScalar().ToString(), out newItemID))
            {
        ...
        public XmlDocument getIsTableOpen(String table)
        {
            ...
            if (!Int32.TryParse(oCmd.ExecuteScalar().ToString(), out tableCount))
            {
