...
namespace WebServicePOS
{
    ...
    public class WS : System.Web.Services.WebService
    {
        ...
        XmlDocument getAgenti()
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                return vfp.getAgenti();
            }
        }

        [WebMethod]
        XmlDocument getDepozite()
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                return vfp.getDepozite();
            }
        }
        [WebMethod]
        XmlDocument getClienti(DateTime initialDate, DateTime finalDate)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                return vfp.getClienti(initialDate, finalDate);
            }
        }
        [WebMethod] 
        XmlDocument getFacturi(DateTime initialDate, DateTime finalDate)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                return vfp.getFacturi(initialDate,finalDate); ;
            }
        }
        [WebMethod]
        XmlDocument getPozitiiFacturi(DateTime initialDate, DateTime finalDate)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                return vfp.getFacturiPozitii(initialDate, finalDate);
            }
        }
        [WebMethod]
        XmlDocument getStoc()
        ...
        DataTable getStocv2()
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                return vfp.getStocv2(); ;
            }
        }

        [WebMethod]
        XmlDocument getSetariWS() 
        {
        ...
        [WebMethod]
        String OLDgetUser(string par,string codUser)
        {
        ...
        [WebMethod]
        XmlDocument getUser(string par, string codUser)
        {
            if (Setari.tokenIsOk(par))
            {
                using (vfpPOS vfp = new vfpPOS())
        ...
        [WebMethod]
        string getCcodOfCard(string par, string card)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
        ...
        [WebMethod]
        XmlDocument getMeseOfUser(string par, string codUser)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument getMeseLibere(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument getProductsOfMasa(string par,string codMasa)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        string getLastUpProd(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument getGest(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument getCateg(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument getProd(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument getProdVanzareRapida(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument getFeluriProduse(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        string saveVanzare(string par,string vanzare)
        {
            // versiune mai veche
            using (vfpPOS vfp = new vfpPOS())
            {
        ...
        [WebMethod]
        string saveVanzareJson(string par, string vanzare)
        {
        ...
        [WebMethod]
        XmlDocument nota(string par,string masa, string numerar, string card, string tag, string suma, string pin, string data, string nrdoc, string detalii, string sursa, string utilizator)
        {
            if (!Setari.tokenIsOk(par))
            {
        ...
        [WebMethod]
        string deschideMasa(string par,string user, string masa)
        {         
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        string elibereazaMasa(string par,string masa)
        {
        ...
        [WebMethod]
        string getDataFiscalaWinPOS(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument epay(string par, string tag, string suma, string pin, string data, string nrdoc, string detalii, string sursa, string utilizator)
        {
            if (!Setari.tokenIsOk(par))
            {
                XmlDocument rasp = new XmlDocument();
        ...
        [WebMethod]
        XmlDocument realizariExtern(string par,string nidtableta, string dela, string panala)
        {
            using (EPay epay = new EPay())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument externi(string par,string nidTableta)
        {
            if (!Setari.tokenIsOk(par))
            {
                XmlDocument rasp = new XmlDocument();
        ...
        [WebMethod]
        string inchidereZi(string par,string nidTableta)
        {
            int iNidTableta;
        ...
        [WebMethod]
        XmlDocument versiune(string par)
        {
            using (EPay epay = new EPay())
            {
        ...
        [WebMethod]
        XmlDocument getUserExtern(string par, string parola)
        {
            using (EPay epay = new EPay())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        string getSetareCardvaloric(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        string AccesGetTip(string par, string tipAcces)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument AccesInit(string par, string tipAcces , string tagClient, string dataFiscala, string sursa, string utilizator)
        {
        ...
        [WebMethod]
        XmlDocument AccesPlata(string par, string utilizator, string tagClient, string pin, string codp, string cant, string pret, string detalii, string sursa)
        {
            //
        ...
        [WebMethod]
        XmlDocument AccesGetCount(string par, string data, string tipAcces)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        //
        [WebMethod]
        XmlDocument getVanzariDeschise(string par, string coduriGest)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        XmlDocument getStariVanzari(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
        ...
        [WebMethod]
        string nextStareVanz(string par, string uid)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
        ...
        [WebMethod]
        XmlDocument getUsers(string par)
        {
            using (vfpPOS vfp = new vfpPOS())
            {
                if (Setari.tokenIsOk(par))
